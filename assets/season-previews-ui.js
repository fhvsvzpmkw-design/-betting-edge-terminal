...
function setButtonCopy(b){
  ...
  const msg=count===null?'SOURCE DESK&nbsp;&nbsp; // &nbsp;&nbsp;PRESS [F6] TO OPEN':`${count} SOURCE${count===1?'':'S'} ON DESK&nbsp;&nbsp; // &nbsp;&nbsp;PRESS [F6] TO OPEN`;
  const html=`<span class="f6Main"><b>[F6]</b>&nbsp; 🥩 MEAT DESK 🥩</span><span class="f6Message">${msg}</span>`;
