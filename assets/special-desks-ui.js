...
function ensureStyle(d){
  ...
  const s=d.createElement('style');s.id=STYLE_ID;s.textContent=`
    ...
    #${CRYPTO_PANEL}{border:1px solid #4a3b76;background:radial-gradient(circle at 50% -20%,rgba(76,51,153,.13),transparent 42%),linear-gradient(180deg,#05050b,#020306 58%,#010204);color:#ddd8f6;box-shadow:inset 0 0 28px rgba(109,77,207,.025)}
    ...
    .cryptoSourceBar{display:grid;grid-template-columns:minmax(0,1.35fr) repeat(3,minmax(110px,.65fr));gap:8px;margin-top:11px}.cryptoSourceCell{border:1px solid rgba(147,121,232,.24);background:#070711;padding:9px 10px;min-width:0}.cryptoSourceCell small{display:block;color:#8177a5;font-size:7px;font-weight:950;letter-spacing:.12em;margin-bottom:4px}.cryptoSourceCell strong,.cryptoSourceCell a{display:block;color:#d1c8f4;font-size:9px;font-weight:950;line-height:1.35;letter-spacing:.045em;text-decoration:none;overflow-wrap:anywhere}.cryptoSourceCell a:hover{color:#fff}.cryptoSourceCell.cryptoNoVig strong{color:#9a90bc}
    .cryptoSummary{margin-top:10px;border-left:4px solid #785dbd;background:#090711;padding:9px 11px;color:#aba2c5;font-size:9px;line-height:1.55;letter-spacing:.025em}.cryptoSummary b{color:#ddd7ef;letter-spacing:.08em}
    .cryptoBoard{display:grid;grid-template-columns:1fr;gap:11px;margin-top:11px}
    .cryptoPick{--status:#9c87ff;position:relative;width:100%;border:2px solid #50456e;border-left:4px solid var(--status);background:#060812;padding:14px;box-shadow:inset 0 0 0 1px rgba(191,176,255,.025),0 0 12px rgba(0,0,0,.26)}
    ...
    .cryptoPickHead{display:flex;justify-content:space-between;gap:15px;align-items:flex-start}.cryptoPickIdentity{min-width:0}.cryptoStatusTag{display:inline-block;border:1px solid var(--status);color:var(--status);background:#03060b;padding:4px 8px;font-size:10px;font-weight:950;letter-spacing:.10em;box-shadow:0 0 9px color-mix(in srgb,var(--status) 18%,transparent)}
    .cryptoPick h3{margin:9px 0 0;color:#f3f1fb;font-size:18px;line-height:1.2;letter-spacing:.055em;text-transform:uppercase}.cryptoMarket{margin-top:5px;color:#9187ad;font-size:10px;font-weight:900;letter-spacing:.08em}.cryptoPickState{text-align:right;min-width:150px}.cryptoPickState small{display:block;color:#827899;font-size:8px;font-weight:950;letter-spacing:.11em;margin-bottom:4px}.cryptoPickState strong{display:block;color:var(--status);font-size:12px;font-weight:950;letter-spacing:.07em;line-height:1.35}.cryptoDecisionTag{display:inline-block;margin-top:6px;border:1px solid var(--status);color:var(--status);padding:3px 7px;font-size:9px;font-weight:950;letter-spacing:.07em}
    .cryptoMarketStrip{margin-top:12px;background:#040710;border:1px solid #654f94;padding:11px;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}.cryptoMarketCell{min-width:0}.cryptoMarketCell small{display:block;color:#807696;font-size:8px;font-weight:950;letter-spacing:.10em;margin-bottom:5px}.cryptoMarketCell strong{display:block;color:#e9e5f6;font-size:17px;font-weight:950;line-height:1.25;overflow-wrap:anywhere}.cryptoMarketCell.marketMove strong{color:#c4b8e8;font-size:11px;line-height:1.4}.cryptoMarketCell.marketDecision strong{color:var(--status);font-size:13px}
    .cryptoSourceNote{margin-top:8px;color:#807790;font-size:9px;line-height:1.45;letter-spacing:.035em}.cryptoSourceNote b{color:#b8aecb}.cryptoWhy{margin-top:10px;border-left:4px solid var(--status);padding:9px 11px;background:#0b0912;color:#b9b3c5;font-size:11px;line-height:1.5}.cryptoWhy b{color:var(--status);letter-spacing:.06em}.cryptoAnalysisBtn{width:100%;margin-top:10px;font:inherit;font-weight:950;padding:9px;background:#100b1c;color:#d7ccff;border:1px solid #725bb0;cursor:pointer;letter-spacing:.06em}.cryptoAnalysisBtn:hover{border-color:#a68cff;color:#fff}.cryptoDetail{margin-top:8px;border:1px dotted #574774;background:#03050a;padding:10px;display:none;color:#9d95ad;font-size:10px;line-height:1.55}.cryptoDetail.open{display:block}.cryptoDetailGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:7px}.cryptoDetailCell{border:1px solid #302942;background:#070711;padding:8px}.cryptoDetailCell small{display:block;color:#746b83;font-size:7px;font-weight:950;letter-spacing:.10em;margin-bottom:4px}.cryptoDetailCell strong{display:block;color:#c8bfd8;font-size:9px;line-height:1.4}
    .cryptoPasses{margin-top:12px;border:1px solid rgba(94,76,143,.30);background:rgba(8,6,18,.60)}.cryptoPasses summary{cursor:pointer;list-style:none;padding:9px 11px;color:#9a90b3;font-size:9px;font-weight:950;letter-spacing:.11em}.cryptoPasses summary::-webkit-details-marker{display:none}.cryptoPasses[open] summary{border-bottom:1px solid rgba(94,76,143,.24)}.cryptoPassList{display:grid;gap:7px;padding:9px}.cryptoPass{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:8px;border-left:3px solid #ff738a;background:#07070d;padding:9px}.cryptoPass strong{color:#bbb4c7;font-size:10px;letter-spacing:.05em}.cryptoPass span{display:block;margin-top:3px;color:#817a8d;font-size:9px;line-height:1.4}.cryptoPass b{color:#ff8295;font-size:9px;letter-spacing:.08em}.cryptoTimestamp{margin-top:10px;text-align:right;color:#6e667e;font-size:8px;font-weight:900;letter-spacing:.08em}
